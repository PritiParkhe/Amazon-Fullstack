...
const CategoryProductsList = () => {
  ...
  const categories = [
    { title: 'Clothes', imageUrl: box1_image },
    { title: 'Health & Personal Care', imageUrl: box2_image },
    { title: 'Furniture', imageUrl: box3_image },
    { title: 'Electronics', imageUrl: box4_image },
    { title: 'Beauty Picks', imageUrl: box5_image },
    { title: 'Pet Care', imageUrl: box6_image },
    { title: 'New Arrival & Toys', imageUrl: box7_image },
    { title: 'Discover Fashion Trends', imageUrl: box8_image },
  ];
    ...
    <div className='container mx-auto px-4 relative -mt-[430px]'>
      ...
      <div className='relative z-10 flex flex-wrap items-center justify-between gap-2'>
        {categories.map((category, index) => (
          <Link
            to={`/product-category/:${category.title}`} // Update route path as per your project structure
            key={index}
          ...
          >
            <div className='mx-4'>
              ...
              <div className='h-[300px]'>
                <img src={category.imageUrl} alt={category.title} className='h-full w-full object-cover shadow-md' />
              </div>
